        ...
        const rolesCreated = yield fastify.prisma.role.createMany({
            data: [
                ...
                },
                {
                    ...
                    aura: client_1.Aura.GOOD,
                    team: client_1.Team.REBEL,
                    description: "The Cyber Brute is a formidable rebel agent known for their exceptional strength and resilience. As a Cyber Brute, you have the ability to protect a fellow player each night. Thanks to your unmatched strength, the Cyber Brute can withstand the first attack directed at them, but they are unable to defend against subsequent attacks. Additionally, the Cyber Brute automatically protects themselves every night.",
                    canTalkNight: false,
