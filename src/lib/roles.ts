...
const ROLES: Record<string, Partial<Role>> = {
  ...
  combatMedic: {
    ...
    team: Team.REBEL,
    description:
      "The Combat Medic acquired his knowledge fighting for government causes in the army for years, until he managed to escape and seek shelter with the rebels. You can choose a player to protect at night, making him immune to attacks. Can't self protect.",
    canTalkNight: false,
  },
...
/* CHAT AQUI \/
 \/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
SE QUISER DEFINIR ALGO NAQUELA INTERFACE Q TAVA LA EM CIMA, TEM Q DEFINIR NO ARQUIVO DO BANCO NA TABELA ROLE É A ULTIMA TABELA Q TA LA
